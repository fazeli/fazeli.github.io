...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".service2").forEach((service2) => {
    service2.addEventListener("click", () => {
      ...
      modalContent.querySelector("h3").textContent =
        service2.querySelector("h4").textContent;
      modalContent.querySelector("p").textContent =
        service2.querySelector("p").textContent;
  ...
  const animateServices = () => {
    const services2 = document.querySelectorAll(".service2");
    services2.forEach((service2, index) => {
      setTimeout(() => {
